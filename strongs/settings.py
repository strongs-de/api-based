...
DATABASES = {
    'default': {
        ...
        'NAME': 'strongs.sqlite',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'strongs.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'strongs.wsgi.application'
...
AUTHENTICATION_BACKENDS = ['strongs.api.auth.AlwaysRootBackend']
